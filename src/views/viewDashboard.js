...
import { viewRodrigoVillanueva } from "./viewRodrigoVillanueva.js";
...
export function viewDashboard() {
  template(html`
    ...
    <div>
      ...
      <button id="btnviewRodrigo">Vista Rodrigo</button>
    </div>
  ...
  $("#btnviewRodrigo")?.addEventListener("click", () =>
    render(viewRodrigoVillanueva)
  );
}
